...
```
Pragya_Verse_KSP_Hackathon/
├── client/                      # Vite + React + TypeScript App
│   ├── src/
│   │   ├── components/          # Reusable UI & Layout Components
│   │   │   ├── layout/          # Navbar, Sidebar, PageHeader, ProtectedRoute
│   │   │   └── ui/              # GlassPanel, Badge, Button, ThemeCornerToggle, PasswordInput
│   │   ├── context/             # LanguageContext (Kannada / English)
│   │   ├── hooks/               # Custom React Hooks
│   │   ├── pages/               # Application Pages & Feature Workspaces
│   │   │   └── dashboards/      # 7 Specialized Role-Based Dashboards
│   │   ├── services/            # API Services, Mock DB, OpenAI Integration
│   │   ├── store/               # Zustand Stores (authStore, themeStore, workspaceStore)
│   │   ├── types/               # TypeScript Schema Definitions
│   │   └── utils/               # PDF Exporters, CSV Generators, RBAC Matrix
│   ├── index.html
│   ├── package.json
│   └── vite.config.ts
└── README.md
...
Developed for the **Karnataka State Police (KSP)** under the **Pragya Verse KSP Hackathon**. Compliant with **Information Technology Act 2000 (Sec 66C / 66D)** and **BNS 2023 Statutory Codification**.
